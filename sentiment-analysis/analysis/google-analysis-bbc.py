        ...
        for data in context_data:
            try:
                ...
                data['analysis']['sentiment'] = json.loads(
                    sentiment_text(data["content"]))
                # data['analysis']['entities'] = json.loads(
                #     entities_text(data["content"]))
                data['analysis']['classifiction'] = json.loads(
                    classify_text(data["content"]))
                # data['analysis']['entities_sentiment'] = json.loads(
                #     entity_sentiment_text(data["text"]))
                # print(data)
    ...
    "Records": [
        {
            ...
            "body": "{\"source\": \"bbc\", \"file\": \"bbc-newsSaudi Arabia.json\", \"text\": null}",
            "attributes": {
